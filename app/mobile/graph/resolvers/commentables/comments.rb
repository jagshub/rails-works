...
class Mobile::Graph::Resolvers::Commentables::Comments < Mobile::Graph::Resolvers::BaseSearchResolver
  ...
  option :include_comment_id, type: ID, with: :noop
  option :exclude_comment_id, type: ID, with: :apply_exclude_comment_id
