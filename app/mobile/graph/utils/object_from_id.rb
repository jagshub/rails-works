...
module Mobile::Graph::Utils::ObjectFromId
  extend self
  ...
  def implements_node_interface?(record)
    type = Mobile::Graph::Utils::ResolveType.from_class(record.class)
    type.interfaces.include? GraphQL::Types::Relay::Node
  rescue Mobile::Graph::Utils::ResolveType::UnknownTypeError
    false
  end
