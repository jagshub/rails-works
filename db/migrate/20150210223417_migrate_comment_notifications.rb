class MigrateCommentNotifications < ActiveRecord::Migration
  ...
  def down
    Activity.where(subject_type: 'User', verb: 'commented_on', object_type: 'Post').delete_all
  end
end
